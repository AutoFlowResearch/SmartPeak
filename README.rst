...
.. image:: https://github.com/dmccloskey/SmartPeak2/blob/feat/aut312/images/workflow.png

- View and verify the workflow steps and input files with ``View | [table]``. 

.. image:: https://github.com/dmccloskey/SmartPeak2/blob/feat/aut312/images/SmartPeakGUIWorkflowTable.png
...
.. image:: https://github.com/dmccloskey/SmartPeak2/blob/feat/aut312/images/SmartPeakGUISequenceTable.png
...
.. image:: https://github.com/dmccloskey/SmartPeak2/blob/feat/aut312/images/SmartPeakGUIRunWorkflowModal.png

- The status of the workflow can be monitored with ``View | info``. 

.. image:: https://github.com/dmccloskey/SmartPeak2/blob/feat/aut312/images/SmartPeakGUIInfo.png
...
.. image:: https://github.com/dmccloskey/SmartPeak2/blob/feat/aut312/images/SmartPeakGUILog.png
...
.. image:: https://github.com/dmccloskey/SmartPeak2/blob/feat/aut312/images/SmartPeakGUIFeatureLinePlot.png

or ``View | features (heatmap)``

.. image:: https://github.com/dmccloskey/SmartPeak2/blob/feat/aut312/images/SmartPeakGUIFeatureHeatmap.png
...
.. image:: https://github.com/dmccloskey/SmartPeak2/blob/feat/aut312/images/SmartPeakGUIFeatureMatrix.png

- The results of calibration curve fitting can be inspected with ``View | Workflow settings | Quant Methods``.

.. image:: https://github.com/dmccloskey/SmartPeak2/blob/feat/aut312/images/SmartPeakGUIQuantMethod.png

- A detailed look at the calibration fitted model and selected points for the model can be seen with ``View | Calibrators``.

.. image:: https://github.com/dmccloskey/SmartPeak2/blob/feat/aut312/images/SmartPeakGUICalibrators.png
...
.. image:: https://github.com/dmccloskey/SmartPeak2/blob/feat/aut312/images/SmartPeakGUIChromViewer.png

- Export the results with ``Actions | Report``. There is an option to choose the set of variables of interest

.. image:: https://github.com/dmccloskey/SmartPeak2/blob/feat/aut312/images/report_dialog.png

- The results will be exported to ``PivotTable.csv`` in the same folder

.. image:: https://github.com/dmccloskey/SmartPeak2/blob/feat/aut312/images/csv_file.png
