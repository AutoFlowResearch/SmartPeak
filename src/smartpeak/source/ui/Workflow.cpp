      ...
      for (const char* s : presets)
      {
        if (ImGui::Selectable(s))
        {
          ...
          if (s_string == "LCMS MRM Unknowns")
            ...
            ids = "LOAD_RAW_DATA EXTRACT_SPECTRA_WINDOWS MERGE_SPECTRA PICK_MS1_FEATURES SEARCH_ACCURATE_MASS MAKE_CONSENSUS_FEATURES STORE_ANNOTATIONS STORE_FEATURES";
