...
{
  TestData testData;
  SessionHandler session_handler; session_handler.setInjectionExplorer();
}

BOOST_AUTO_TEST_CASE(setTransitionExplorer1)
{
  TestData testData;
  SessionHandler session_handler; session_handler.setTransitionExplorer();
}

BOOST_AUTO_TEST_CASE(setFeatureExplorer1)
{
  TestData testData;
  SessionHandler session_handler; session_handler.setFeatureExplorer();
}

BOOST_AUTO_TEST_CASE(setSequenceTable1)
{
  TestData testData;
  SessionHandler session_handler; session_handler.setSequenceTable(testData.sequenceHandler);
}

BOOST_AUTO_TEST_CASE(setTransitionsTable1)
{
  TestData testData;
  SessionHandler session_handler; session_handler.setTransitionsTable(testData.sequenceHandler);
}
...
{
  TestData testData;
  SessionHandler session_handler; session_handler.setParametersTable(testData.sequenceHandler);
}

BOOST_AUTO_TEST_CASE(setQuantMethodTable1)
{
  TestData testData;
  SessionHandler session_handler; session_handler.setQuantMethodTable(testData.sequenceHandler);
}

BOOST_AUTO_TEST_CASE(setStdsConcsTable1)
{
  TestData testData;
  SessionHandler session_handler; session_handler.setStdsConcsTable(testData.sequenceHandler);
}

BOOST_AUTO_TEST_CASE(setComponentFiltersTable1)
{
  TestData testData;
  SessionHandler session_handler; session_handler.setComponentFiltersTable(testData.sequenceHandler);
}

BOOST_AUTO_TEST_CASE(setComponentGroupFiltersTable1)
{
  TestData testData;
  SessionHandler session_handler; session_handler.setComponentGroupFiltersTable(testData.sequenceHandler);
}

BOOST_AUTO_TEST_CASE(setComponentQCsTable1)
{
  TestData testData;
  SessionHandler session_handler; session_handler.setComponentQCsTable(testData.sequenceHandler);
}

BOOST_AUTO_TEST_CASE(setComponentGroupQCsTable1)
{
  TestData testData;
  SessionHandler session_handler; session_handler.setComponentGroupQCsTable(testData.sequenceHandler);
}

BOOST_AUTO_TEST_CASE(setFeatureTable1)
{
  TestData testData;
  SessionHandler session_handler; session_handler.setFeatureTable(testData.sequenceHandler);
}
...
{
  TestData testData;
  SessionHandler session_handler; session_handler.setSequenceDataAndFilters(testData.sequenceHandler);
}

BOOST_AUTO_TEST_CASE(setTransitionDataAndFilters1)
{
  TestData testData;
  SessionHandler session_handler; session_handler.setTransitionsDataAndFilters(testData.sequenceHandler);
}
