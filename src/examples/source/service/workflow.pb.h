...
class WorkflowParameters PROTOBUF_FINAL :
 ...
 public:
  ...
  void set_dataset_path(const std::string& value);
  void set_dataset_path(std::string&& value);
  void set_dataset_path(const char* value);
  void set_dataset_path(const char* value, size_t size);
  std::string* mutable_dataset_path();
  std::string* release_dataset_path();
  void set_allocated_dataset_path(std::string* dataset_path);
  private:
  const std::string& _internal_dataset_path() const;
  void _internal_set_dataset_path(const std::string& value);
...
inline void WorkflowParameters::set_dataset_path(const std::string& value) {
  _internal_set_dataset_path(value);
...
inline std::string* WorkflowParameters::mutable_dataset_path() {
  ...
  return _internal_mutable_dataset_path();
}
...
inline void WorkflowParameters::_internal_set_dataset_path(const std::string& value) {
  ...
  dataset_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void WorkflowParameters::set_dataset_path(std::string&& value) {
  
  dataset_path_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:SmartPeakServer.WorkflowParameters.dataset_path)
}
inline void WorkflowParameters::set_dataset_path(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  dataset_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:SmartPeakServer.WorkflowParameters.dataset_path)
}
inline void WorkflowParameters::set_dataset_path(const char* value,
    size_t size) {
  
  dataset_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:SmartPeakServer.WorkflowParameters.dataset_path)
}
inline std::string* WorkflowParameters::_internal_mutable_dataset_path() {
  
  return dataset_path_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* WorkflowParameters::release_dataset_path() {
  ...
  return dataset_path_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
