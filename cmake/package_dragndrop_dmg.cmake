...
if (DEFINED CMAKE_VERSION AND NOT "${CMAKE_VERSION}" VERSION_LESS "3.5")
  ...
  if (DEFINED CPACK_BUNDLE_APPLE_CERT_APP)
    add_custom_target(signed_dist
      ...
      COMMAND ${SMARTPEAK_HOST_DIRECTORY}/cmake/MacOSX/notarize_app.sh ${CPACK_PACKAGE_FILE_NAME}.dmg de.openms ${SIGNING_EMAIL} CODESIGNPW ${SMARTPEAK_HOST_BINARY_DIRECTORY}
